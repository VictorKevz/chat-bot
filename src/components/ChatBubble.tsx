...
const ChatBubble = ({ data }: ChatBubbleProps) => {
  ...
  return (
    <div className="w-full flex items-center justify-between z-20">
      {isUser ? (
        <div className="w-[48%] flex items-center gap-2.5 p-3 bg-[var(--neutral-200)] backdrop-blur-[1.8rem] rounded-xl shadow-[4rem]">
        ...
        <div className="w-[48%] flex flex-row-reverse items-center gap-2.5 p-3 bg-black/60 backdrop-blur-[1.5rem] rounded-xl shadow-[4rem] ml-auto">
