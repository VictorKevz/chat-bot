...
app.post("/api/chat", async (req, res) => {
    try {
        ...
        const systemMessage = {
            role: "system",
            content: `You are an AI assistant for Victor. Here is Victor's profile: ${JSON.stringify(profile)}. Always use this information to answer questions about Victor.`,
        };
        const userMessage = {
            role: "user",
            content: message,
